...
$string['test_tmms24'] = 'Exploración de las Habilidades Socioemocionales';
...
$string['action_completed'] = 'Completado';

// Defaults
$string['default_activity_name'] = 'Camino de Autodescubrimiento';

// Teacher View
$string['teacher_view_title'] = 'Progreso del Curso';
$string['view_full_report'] = 'Ver reporte completo en el Panel Administrativo';
