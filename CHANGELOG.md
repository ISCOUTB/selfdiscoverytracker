...
### Corregido
- Solución a error de permisos en propiedades protegidas de Moodle (`cm_info`) que generaba excepciones en la vista del profesor al limpiar caché.
...
### Cambiado
- Uso de "exploraciones" en lugar de "tests" en todos los textos del módulo.
...
### Agregado
- Soporte para calificaciones en el módulo Self Discovery Tracker.
